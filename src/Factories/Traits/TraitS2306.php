...
trait TraitS2306
{
    ...
    protected function toNodeS120()
    {
        ...
        if (isset($this->std->infotsvalteracao->infocomplementares->localtrabgeral)) {
            $localgeral = $this->dom->createElement("localTrabGeral");
            $this->dom->addChild(
                $localgeral,
                "tpInsc",
                $this->std->infotsvalteracao->infocomplementares->localtrabgeral->tpinsc,
                true
            );
            $this->dom->addChild(
                $localgeral,
                "nrInsc",
                $this->std->infotsvalteracao->infocomplementares->localtrabgeral->nrinsc,
                true
            );
            $this->dom->addChild(
                $localgeral,
                "descComp",
                !empty($this->std->infotsvalteracao->infocomplementares->localtrabgeral->desccomp) ?
                $this->std->infotsvalteracao->infocomplementares->localtrabgeral->desccomp : null,
                false
            );
