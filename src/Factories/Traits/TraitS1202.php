    ...
    protected function toNodeS100()
    {
        ...
        if (!empty($this->std->idetrabalhador->infocomplem)) {
            ...
            $this->dom->addChild(
                $info,
                "nmTrab",
                $this->std->idetrabalhador->infocomplem->nmtrab,
                true
            );
            $this->dom->addChild(
                $info,
                "dtNascto",
                $this->std->idetrabalhador->infocomplem->dtnascto,
                true
            );
            if (!empty($this->std->idetrabalhador->infocomplem->sucessaovinc)) {
                $vin =  $this->std->idetrabalhador->infocomplem->sucessaovinc;
        ...
        foreach ($this->std->dmdev as $dm) {
            ...
            if (!empty($dm->infoperant)) {
                ...
                $this->dom->addChild(
                    $perant,
                    "remunOrgSuc",
                    $dminfoperant->remunorgsuc,
                    true
                );
                foreach ($dminfoperant->ideperiodo as $per) {
