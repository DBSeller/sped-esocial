    ...
    protected function toNodeS100()
    {
        ...
        if (isset($this->std->trabalhador->endereco->brasil)) {
            ...
            $this->dom->addChild(
                $brasil,
                "tpLograd",
                !empty($this->std->trabalhador->endereco->brasil->tplograd) ? $this->std->trabalhador->endereco->brasil->tplograd : null,
                false
            );
            $this->dom->addChild(
                $brasil,
        ...
        $trabalhador->appendChild($endereco);
        if (isset($this->std->trabalhador->trabimg)) {
            $trabImig = $this->dom->createElement("trabImig");
            $this->dom->addChild(
                $trabImig,
                "tmpResid",
                !empty($this->std->trabalhador->trabimig->tmpresid) ? $this->std->trabalhador->trabimig->tmpresid : null,
                false
            );
            $this->dom->addChild(
                $trabImig,
                "condIng",
                $this->std->trabalhador->trabimig->conding,
                true
            );
        ...
        if (isset($this->std->vinculo->inforegimetrab->infoceletista)) {
            ...
            $this->dom->addChild(
                $celetista,
                "nrProcTrab",
                !empty($this->std->vinculo->inforegimetrab->infoceletista->nrproctrab) ? $this->std->vinculo->inforegimetrab->infoceletista->nrproctrab : null,
                false
            );
            $this->dom->addChild(
                $celetista,
            ...
            //FGTS (opcional)
            if (isset($this->std->vinculo->inforegimetrab->infoceletista->fgts)) {
                $fgts = $this->dom->createElement("FGTS");
                $this->dom->addChild(
                    $fgts,
                    "dtOpcFGTS",
                    $this->std->vinculo->inforegimetrab->infoceletista->fgts->dtopcfgts,
                    true
                );
                $celetista->appendChild($fgts);
            }
            // Trabalhador Temporario (opcional)
            if (isset($this->std->vinculo->inforegimetrab->infoceletista->trabtemporario)) {
                $trabTemporario = $this->dom->createElement("trabTemporario");
                $this->dom->addChild(
                    $trabTemporario,
                ...
                //substituido (opcional) ARRAY
                if (isset($this->std->vinculo->inforegimetrab->infoceletista->trabtemporario->idetrabsubstituido)) {
                    foreach ($this->std->vinculo->inforegimetrab->infoceletista->trabtemporario->idetrabsubstituido as $subs) {
                        $ideTrabSubstituido = $this->dom->createElement("ideTrabSubstituido");
                        $this->dom->addChild(
                            $ideTrabSubstituido,
                            "cpfTrabSubst",
        ...
        if (isset($this->std->vinculo->inforegimetrab->infoestatutario)) {
            ...
            $this->dom->addChild(
                $estatutario,
                "indTetoRGPS",
                !empty($this->std->vinculo->inforegimetrab->infoestatutario->indtetorgps) ? $this->std->vinculo->inforegimetrab->infoestatutario->indtetorgps : null,
                false
            );
            $this->dom->addChild(
                $estatutario,
                "indAbonoPerm",
                !empty($this->std->vinculo->inforegimetrab->infoestatutario->indabonoperm) ? $this->std->vinculo->inforegimetrab->infoestatutario->indabonoperm : null,
                false
            );
            $this->dom->addChild(
                $estatutario,
                "dtIniAbono",
                !empty($this->std->vinculo->inforegimetrab->infoestatutario->dtiniabono) ? $this->std->vinculo->inforegimetrab->infoestatutario->dtiniabono : null,
                false
            );
            //encerra estatutario
            $infoRegimeTrab->appendChild($estatutario);
        ...
        $this->dom->addChild(
            $contrato,
            "nmCargo",
            !empty($this->std->vinculo->infocontrato->nmcargo) ? $this->std->vinculo->infocontrato->nmcargo : null,
            false
        );
        ...
        $this->dom->addChild(
            $contrato,
            "dtIngrCargo",
            !empty($this->std->vinculo->infocontrato->dtingrcargo) ? $this->std->vinculo->infocontrato->dtingrcargo : null,
            false
        );
        $this->dom->addChild(
            $contrato,
            "nmFuncao",
            !empty($this->std->vinculo->infocontrato->nmfuncao) ? $this->std->vinculo->infocontrato->nmfuncao : null,
            false
        );
        $this->dom->addChild(
            $contrato,
            "CBOFuncao",
            !empty($this->std->vinculo->infocontrato->cbofuncao) ? $this->std->vinculo->infocontrato->cbofuncao : null,
            false
        );
        $this->dom->addChild(
            $contrato,
            "acumCargo",
            !empty($this->std->vinculo->infocontrato->acumcargo) ? $this->std->vinculo->infocontrato->acumcargo : null,
            false
        );
        $this->dom->addChild(
            $contrato,
        ...
        if (isset($this->std->vinculo->infocontrato->remuneracao)) {
            $remuneracao = $this->dom->createElement("remuneracao");
            $this->dom->addChild(
                $remuneracao,
                "vrSalFx",
        ...
        //duracao (opcional)
        if (isset($this->std->vinculo->infocontrato->duracao)) {
            $duracao = $this->dom->createElement("duracao");
            $this->dom->addChild(
                $duracao,
                "tpContr",
        ...
        if (isset($this->std->vinculo->infocontrato->horcontratual)) {
            ...
            $this->dom->addChild(
                $horContratual,
                "qtdHrsSem",
                !empty($this->std->vinculo->infocontrato->horcontratual->qtdhrssem) ? $this->std->vinculo->infocontrato->horcontratual->qtdhrssem : null,
                false
            );
            $this->dom->addChild(
                $horContratual,
            ...
            $this->dom->addChild(
                $horContratual,
                "horNoturno",
                $this->std->vinculo->infocontrato->horcontratual->hornoturno,
                true
            );
            $this->dom->addChild(
                $horContratual,
                "dscJorn",
                $this->std->vinculo->infocontrato->horcontratual->dscjorn,
                true
            );
        ...
        //observacoes (opcional) array
        if (isset($this->std->vinculo->infocontrato->observacoes)) {
            foreach ($this->std->vinculo->infocontrato->observacoes as $obs) {
                $observacao = $this->dom->createElement("observacoes");
                $this->dom->addChild(
                    $observacao,
                    "observacao",
                    $obs->observacao,
                ...
                $contrato->appendChild($observacao);
            }
        }
        //treiCap (opcional) array
        if (isset($this->std->vinculo->infocontrato->treicap)) {
            foreach ($this->std->vinculo->infocontrato->treicap as $treicap) {
                $treinamento = $this->dom->createElement("treiCap");
                $this->dom->addChild(
                    $treinamento,
                    "codTreiCap",
                    $treicap->codtreicap,
                ...
                $contrato->appendChild($treinamento);
            }
        }
        //encerra contrato
        $vinculo->appendChild($contrato);
        ...
        if (isset($this->std->vinculo->sucessaovinc)) {
            ...
            $this->dom->addChild(
                $sucessaoVinc,
                'tpInsc',
                $this->std->vinculo->sucessaovinc->tpinsc,
                true
            );
            $this->dom->addChild(
                $sucessaoVinc,
                "nrInsc",
                $this->std->vinculo->sucessaovinc->nrinsc,
                true
            );
            $this->dom->addChild(
                $sucessaoVinc,
        ...
        if (isset($this->std->vinculo->cessao)) {
            ...
            $this->dom->addChild(
                $cessao,
                "dtIniCessao",
                $this->std->vinculo->cessao->dtinicessao,
                true
            );
    ...
    protected function toNodeS120()
    {
        ...
        if (isset($this->std->vinculo->inforegimetrab->infoceletista)) {
            ...
            if (isset($this->std->vinculo->inforegimetrab->infoceletista->aprend)) {
                ...
                if (isset($this->std->vinculo->inforegimetrab->infoceletista->aprend->tpinsc)
                    && !empty($this->std->vinculo->inforegimetrab->infoceletista->aprend->tpinsc)) {
                    $this->dom->addChild(
                        $aprendiz,
                        "tpInsc",
                        $this->std->vinculo->inforegimetrab->infoceletista->aprend->tpinsc,
                ...
                if (isset($this->std->vinculo->inforegimetrab->infoceletista->aprend->nrinsc)
                    && !empty($this->std->vinculo->inforegimetrab->infoceletista->aprend->nrinsc)) {
                    $this->dom->addChild(
                        $aprendiz,
                        "nrInsc",
                        $this->std->vinculo->inforegimetrab->infoceletista->aprend->nrinsc,
