    ...
    protected function toNodeS120()
    {
        ...
        if (!empty($this->std->altcontratual->vinculo->inforegimetrab->infoceletista)) {
            ...
            if (!empty($this->std->altcontratual->vinculo->inforegimetrab->infoceletista->aprend)) {
                ...
                if (isset($this->std->altcontratual->vinculo->inforegimetrab->infoceletista->aprend->tpinsc)
                    && !empty($this->std->altcontratual->vinculo->inforegimetrab->infoceletista->aprend->tpinsc)) {
                    $this->dom->addChild(
                        $aprend,
                        "tpInsc",
                        $this->std->altcontratual->vinculo->inforegimetrab->infoceletista->aprend->tpinsc,
                ...
                if (isset($this->std->altcontratual->vinculo->inforegimetrab->infoceletista->aprend->nrinsc)
                    && !empty($this->std->altcontratual->vinculo->inforegimetrab->infoceletista->aprend->nrinsc)) {
                    $this->dom->addChild(
                        $aprend,
                        "nrInsc",
                        $this->std->altcontratual->vinculo->inforegimetrab->infoceletista->aprend->nrinsc,
